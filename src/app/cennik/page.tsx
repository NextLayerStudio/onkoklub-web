...
export default function CennikPage() {
  return (
    <main className="min-h-screen bg-[#FFF3F9] font-sans">
      ...
      <section className="px-5 pb-10">
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            { icon: RefreshCw, label: "Zrušiš kedykoľvek", sub: "Bez záväzkov" },
      ...
      {/* Cenové karty */}
      <section className="px-5 pb-14 flex flex-col gap-4">

        {/* Ročné — odporúčané */}
        <div className="rounded-[1.8rem] bg-[#6F2380] px-6 py-7 relative overflow-hidden">
          ...
          <Link
            ...
            className="block w-full rounded-full bg-[#FDA4C7] text-white font-black text-base py-4 text-center"
          >
            Začať ročne — 60 €
          </Link>
        </div>
        ...
        {/* Mesačné */}
        <div className="rounded-[1.8rem] bg-white border border-[#FDA4C7]/20 px-6 py-7">
          ...
          <Link
            ...
            className="block w-full rounded-full border-2 border-[#FDA4C7] text-[#FDA4C7] font-black text-base py-4 text-center"
          >
            Začať mesačne — 5 €
          </Link>
        </div>

        <p className="text-[#6F2380]/35 text-[11px] text-center leading-relaxed px-2">
          Platba kartou online cez GoPay. Bezpečná platba, šifrované spojenie.
        </p>
      </section>

      {/* Screenshot platobnej/členskej sekcie */}
      <section className="px-5 pb-14">
        <h2 className="text-xl font-black text-[#6F2380] mb-5">Čo ťa čaká po registrácii</h2>
        <div className="flex flex-col gap-3">
          <div className="w-full aspect-video rounded-[2rem] bg-[#6F2380]/15 flex items-center justify-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="aspect-square rounded-2xl bg-[#6F2380]/15 flex items-center justify-center">
              <p className="text-[#6F2380]/25 text-[10px] font-semibold text-center px-2">[IMG-24] OKkarta</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 pb-16">
        <div className="rounded-[2rem] bg-[#6F2380] px-6 py-10 text-center">
          <h2 className="text-[2rem] font-black text-white leading-tight mb-3">Prvý krok stačí.</h2>
          <p className="text-white/65 text-sm leading-relaxed mb-7">
            Registrácia trvá 2 minúty. Kedykoľvek môžeš odísť.
          </p>
          <Link href="/register" className="block w-full rounded-full bg-[#FDA4C7] text-white font-black text-base py-4">
            Chcem sa pripojiť
          </Link>
        </div>
      </section>
